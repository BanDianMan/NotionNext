...
const BLOG = {
  API_BASE_URL: process.env.API_BASE_URL || 'https://rhinestone-eye-555.notion.site/api/v3', // API默认请求地址,可以配置成自己的地址例如：https://[xxxxx].notion.site/api/v3
  // Important page_id！！！Duplicate Template from  https://tanghh.notion.site/02ab3b8678004aa69e9e415905ef32a5
  NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID || 'c48bb55842bd4fbf88c2b64c18298963',
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '永远少年', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://heyiwen.com', // 网站地址
